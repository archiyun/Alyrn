...
[06-02](https://github.com/akiba-miku/high-concurrency-runtime/commit/744c02cfc7f3e7f60744e12185d64350a016dd6f#diff-4e534af418bb39b0da64637d67499c40320d3d87274954bccb1e54548e9fe7c8): 数据结构和哈希算法统一挪到`coropact::ds`模块。且加入了跨树检查和每树独立的哨兵节点。--缺点 节点占了48字节， 颜色， 当前树的指针， intree标识， 内部的对象指针索引。 太费内存。
