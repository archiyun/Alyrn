...
description: Maintain runtime/net reactor, EventLoop, Channel, TCP, poller, timerfd, and backend code. Use for net-layer patches, reviews, lifetime fixes, and threading changes.
---

# runtime/net Maintenance
...
- `runtime_integration_tests` filters for EventLoop/TcpServer when available
