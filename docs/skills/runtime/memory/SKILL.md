...
description: Maintain runtime/memory arenas, fixed block pools, object pools, and PMR adapters. Use for allocator ownership, alignment, reset, cleanup, and pool lifetime patches.
---
...
- `runtime/gateway`
- `runtime/log`
- `runtime/time` for allocator primitives
