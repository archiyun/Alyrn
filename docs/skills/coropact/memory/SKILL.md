...
description: Maintain coropact/memory arenas, fixed block pools, object pools, and PMR adapters. Use for allocator ownership, alignment, reset, cleanup, and pool lifetime patches.
---

# coropact/memory Maintenance
