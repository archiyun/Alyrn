...
description: Maintain the coropact/net Reactor transport, EventLoop, Channel, poller, sockets, and timers. Use for net-layer patches, reviews, lifetime fixes, and threading changes.
---

# coropact/net Maintenance
