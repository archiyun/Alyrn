...
description: Maintain alyrn/time Duration, Deadline, Timer, TimerId, and timer indexes. Use for monotonic clock semantics, timer ordering, cancellation handles, and time-layer dependency reviews.
---

# alyrn/time Maintenance
...
implementation types. They are not exported by `alyrn/time.h`. Backend
