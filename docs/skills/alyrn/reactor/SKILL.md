...
description: Maintain the alyrn/reactor epoll Reactor, Loop, Channel, poller, and timers. Use for Reactor-layer patches, reviews, lifetime fixes, and threading changes.
---

# alyrn/reactor Maintenance
