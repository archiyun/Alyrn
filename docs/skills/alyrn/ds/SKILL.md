...
description: Maintain alyrn/ds intrusive containers, heaps, and trees. Use for data-structure invariants and zero-ownership container patches.
---

# alyrn/ds Maintenance
