...
#include "coropact/experimental/ds/intrusive_quadheap.h"
...
struct TimerJob : coropact::experimental::ds::HeapNode<TimerJob> {
...
using TimerHeap = coropact::experimental::ds::IntrusiveQuadHeap<TimerJob, &TimerJobLess>;
