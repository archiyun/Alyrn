...
struct Item : alyrn::ds::QueueNode<Item> {
...
int main() {
  ...
  alyrn::ds::IntrusiveQueue<Item> queue;
  ...
  alyrn::ds::IntrusiveQueue<Item> moved(std::move(queue));
  ...
  alyrn::ds::IntrusiveQueue<Item> suffix;
  ...
  alyrn::ds::IntrusiveQueue<Item> assigned;
