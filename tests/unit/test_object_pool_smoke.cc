...
bool TestAcquireAndRelease() {
    ...
    alyrn::detail::ObjectPool<TrackedObject, 2> pool;
...
bool TestAcquireScoped() {
    ...
    alyrn::detail::ObjectPool<TrackedObject, 1> pool;
    {
...
void ReleaseOverflowFromAnotherPool() {
    alyrn::detail::ObjectPool<TrackedObject, 1> source;
    alyrn::detail::ObjectPool<TrackedObject, 1> destination;
