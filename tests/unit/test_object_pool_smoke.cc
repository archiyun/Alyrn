...
bool TestAcquireAndRelease() {
    ...
    alyrn::detail::memory::ObjectPool<TrackedObject, 2> pool;
...
bool TestAcquireScoped() {
    ...
    alyrn::detail::memory::ObjectPool<TrackedObject, 1> pool;
    {
...
void ReleaseOverflowFromAnotherPool() {
    alyrn::detail::memory::ObjectPool<TrackedObject, 1> source;
    alyrn::detail::memory::ObjectPool<TrackedObject, 1> destination;
