...
//   ITERATIONS=1000000 FRAME_POOL=0 build-uring/examples/luring/demo_bench_frame_churn
//   ITERATIONS=1000000 FRAME_POOL=1 build-uring/examples/luring/demo_bench_frame_churn
