...
class LoopShutdownParticipant : public ::alyrn::detail::ListNode<LoopShutdownParticipant> {
public:
...
//
// This duplicates the Epoll registry on purpose. kqueue is a parallel
...
private:
  ::alyrn::detail::IntrusiveList<LoopShutdownParticipant> participants_;
};
