...
[[nodiscard]] coropact::base::Result<Endpoint> ParseIpAddress(std::string_view ip,
                                                              std::uint16_t port);
...
[[nodiscard]] coropact::base::Result<Endpoint> get_local_addr(int fd);

// Returns the peer socket address connected to fd.
[[nodiscard]] coropact::base::Result<Endpoint> get_peer_addr(int fd);
